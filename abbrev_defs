...
(define-abbrev-table 'fuel-debug-mode-abbrev-table '())

(define-abbrev-table 'fuel-debug-uses-mode-abbrev-table '())

(define-abbrev-table 'fuel-help-mode-abbrev-table '())

(define-abbrev-table 'fuel-listener-mode-abbrev-table '())

(define-abbrev-table 'fuel-xref-mode-abbrev-table '())
...
(define-abbrev-table 'k-mode-abbrev-table '())

(define-abbrev-table 'liquid-mode-abbrev-table '())
